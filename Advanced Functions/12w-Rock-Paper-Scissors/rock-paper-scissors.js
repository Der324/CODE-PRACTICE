    ...
    */
    ...
    function autoPlay() {
      if (!isAutoPlaying) {
        ...
        //soln to 12t
        //'Auto Play'button so that when the game is auto playing, the text in the button is 'Stop Playing'
        ...
        //Otherwise the text in button is 'Auto Play'
        document.querySelector('.js-auto-play-button')
          .innerHTML = 'Auto Play';
    ...
    document.querySelector('.js-auto-play-button')
      ...
      //updated Reset Score button to use .addEventListener('click',...)
    ...
    document.body.addEventListener('keydown', (event) => {
      if (event.key === 'r') {
        ...
        //Updating code to keyboard 'a' for autoplaying
      } else if (event.key === 'a') {
        autoPlay();

        //Using 'Backspace' key to reset the score.
